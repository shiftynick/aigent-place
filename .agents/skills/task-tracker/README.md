...
The project's local, zero-dependency file-based kanban. The Codex-facing
source of truth is this folder under `.agents/skills/`.
...
node .agents/skills/task-tracker/scripts/task.mjs archive --dry-run
```
...
```bash
cd .agents/skills/task-tracker/scripts
