...
- Apply the SDLC question rule through the question format below and wait for
...
5. If an answer conflicts with earlier intent, repository evidence, or a
   recorded decision, explain the practical conflict and ask which should win.
...
Return a compact list of confirmed decisions and their reasons, followed by
