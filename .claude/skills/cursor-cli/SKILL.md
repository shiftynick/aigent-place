...
node .claude/skills/cursor-cli/scripts/cursor-agent.mjs --model <model-id> --workspace <repo-root> --prompt "<instruction>"
node .claude/skills/cursor-cli/scripts/cursor-agent.mjs --model <model-id> --workspace <repo-root> --mode plan --prompt "<instruction>" --context-file <path>
node .claude/skills/cursor-cli/scripts/cursor-agent.mjs --model <model-id> --workspace <repo-root> --prompt "<review instruction>" --context-file packet.diff
```
...
```text
node .claude/skills/cursor-cli/scripts/cursor-agent.mjs --model <model-id> --allow-write --workspace <repo-root> --prompt "<bounded task>"
```
