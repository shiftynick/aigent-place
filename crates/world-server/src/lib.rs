...
pub use heightfield::{
    ...
    HeightfieldError, TerrainColumn, CHUNK_SIZE_MM, EXACT_GROUNDING_MAX_RESIDUAL_STEPS,
    EXACT_GROUNDING_MAX_ULP_RADIUS, GENERATED_HEIGHT_MAX_MM, GENERATED_HEIGHT_MIN_MM,
